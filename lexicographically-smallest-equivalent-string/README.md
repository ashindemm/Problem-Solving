<h2>1061. Lexicographically Smallest Equivalent String</h2><h3>Medium</h3><hr><div><p>You are given two strings of the same length <code>s1</code> and <code>s2</code> and a string <code>baseStr</code>.</p>
